...
plt.ylabel('MSE')
plt.plot(range(1,9),results_train,'bo')
train_line, = plt.plot(range(1,9),results_train,'b-')
plt.plot(range(1,9),results_test,'go')
test_line, = plt.plot(range(1,9),results_test,'g-')
